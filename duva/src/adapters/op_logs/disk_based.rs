...
mod tests {
    ...
    #[test]
    fn test_follower_full_sync_replaces_all_segments() -> Result<()> {
        // GIVEN
        let dir = TempDir::new()?;
        let path = dir.path();
    ...
    #[test]
    fn test_follower_full_sync_handles_empty_ops() -> Result<()> {
        // GIVEN
        let dir = TempDir::new()?;
        let path = dir.path();
    ...
    #[test]
    fn test_follower_full_sync_handles_large_number_of_ops() -> Result<()> {
        // GIVEN
        let dir = TempDir::new()?;
        let path = dir.path();
        let mut op_logs = FileOpLogs::new(path)?;
